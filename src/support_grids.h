...
// XXX: this is "redefined" to avoid (right now) bringing in support-grids-config.h, 
// but it needs to be considered how this can be merged
#define S_MAX_GRIDS (25)
...
typedef sgrid_ptr s_grids[S_MAX_GRIDS]; 
